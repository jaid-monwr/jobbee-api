//Controllers are files where we define the routes definitions
...
exports.deleteJob = catchAsyncErrors(async (req, res, next) => {
  ...
  job = await Job.findByIdAndDelete(req.params.id); //Same work as Job.remove()
